...
class __TwigTemplate_08dc4bf6a3f74ddfa42a287e5311848d801c428e5ed8a67e1cbb626bbaa9a1ef extends Twig_Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        // line 6
        echo "    <h1>page de ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 6, $this->source); })()), "firstname", array()), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 6, $this->source); })()), "lastname", array()), "html", null, true);
        echo "</h1>
    ...
    {
        return array (  115 => 23,  109 => 20,  102 => 16,  96 => 13,  93 => 12,  89 => 11,  85 => 10,  80 => 8,  72 => 6,  63 => 5,  45 => 3,  15 => 1,);
    }
...
{% block body %}
    <h1>page de {{ user.firstname }} {{ user.lastname }}</h1>

    <p>mail : {{ user.email }}</p>

    <h2>{{ user.firstname }} articles</h2>
    ...
    {% endfor %}
{% endblock %}", "user/profile.html.twig", "/app/templates/user/profile.html.twig");
    }
}
