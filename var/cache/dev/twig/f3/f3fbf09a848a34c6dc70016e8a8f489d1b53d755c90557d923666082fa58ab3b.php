...
class __TwigTemplate_8ea3abc383807f4416392265c2474f510568b1c17ec0a54e4856eb879e110220 extends Twig_Template
{
    private $source;
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            // line 10
            echo "        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profile", array("id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", array()))), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  108 => 16,  104 => 15,  100 => 14,  96 => 12,  81 => 10,  77 => 9,  72 => 6,  63 => 5,  45 => 3,  15 => 1,);
    }
...
{% block body %}
    ...
    <ul>
        {% for user in users %}
        <li><a href=\"{{ path('profile', {'id': user.id}) }}\">{{ user.firstname }} | {{ user.lastname }} | {{ user.email }}</li>
        {% endfor %}
    </ul>
<div class=\"example-wrapper\">
    {{ form_start(form) }}
